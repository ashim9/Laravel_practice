...
{{-- @include('pages.header',['name' => 'Abhinash']) --}}
{{-- @include('pages.header') --}}

{{-- @includeWhen($boolean, 'pages.header',['names'=> $fruits] ) --}}
{{-- @includeWhen(empty($name), 'pages.header',['names'=> $fruits] ) --}}


{{-- @includeUnless(empty($name), 'pages.header',['names'=> $fruits] )
